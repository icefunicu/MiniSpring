package com.icefun.spring.aop;

import com.icefun.spring.MiniApplicationContext;
import com.icefun.spring.aop.advisor.Advice;
import com.icefun.spring.aop.advisor.Advisor;
import com.icefun.spring.aop.advisor.MethodMatcher;
import com.icefun.spring.aop.advisor.Pointcut;
import com.icefun.spring.aop.proxy.ProxyFactory;
import com.icefun.spring.aop.proxy.SingletonTargetSource;
import com.icefun.spring.core.OrderComparator;
import com.icefun.spring.interfaces.ApplicationContextAware;
import com.icefun.spring.interfaces.AspectJAdvisorFactory;
import com.icefun.spring.interfaces.SmartInstantiationAwareBeanPostProcessor;
...
/**
 * 在MiniApplicationContext容器 自己注入并且生成
...
public class AnnotationAwareAspectJAutoProxyCreator implements SmartInstantiationAwareBeanPostProcessor, ApplicationContextAware {
    ...
    @Override
    public void setApplicationContext(MiniApplicationContext applicationContext) {
