...
import com.icefun.spring.anno.*;
import com.icefun.spring.aop.AnnotationAwareAspectJAutoProxyCreator;
import com.icefun.spring.aop.proxy.LazyInjectTargetSource;
import com.icefun.spring.aop.proxy.ProxyFactory;
import com.icefun.spring.interfaces.*;
        ...
        try {
            ...
            if (beanDefinition.isSingleton()) {
                ...
                this.singletonFactories.put(beanName, () -> {
                    ...
                    for (BeanPostProcessor beanPostProcessor : MiniApplicationContext.this.beanPostProcessorList) {
